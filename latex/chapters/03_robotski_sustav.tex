...
KUKA KMR iiwa mobilni je manipulator sastavljen od dviju serijskih komponenti: omnidirekcijske
...
Platforma se giba pomoću četiriju Mecanum kotača. Svaki se kotač sastoji od niza valjaka
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{figures/mecanum.jpg}
...
Za hvatanje kvake izrađena je prilagođena prihvatnica. Budući da se rad provodi isključivo u
...
\begin{figure}[H]
    ...
    \caption{Položaj vrha alata}
    \label{fig:gripper-dim}
\end{figure}
...
Radnu okolinu čine dva modela vrata, zakretna i klizna. Oba su izgrađena od osnovnih
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.9\textwidth]{figures/doors.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        Raspon gibanja       & 0--1,57 rad                              & 0--0,8 m                                     \\
...
kod stvarnih vrata. Zglob brave, koji bi omogućio zakretanje kvake, \textbf{zavaren je u nepomični
...
raditi na rasponu vrata. Otpor je razdvojen na tri fizikalno različita člana:
...
vjerno preslikati određena vrata, nego spriječiti da naučena politika ovisi o jednoj
vrijednosti otpora. Kod zakretnih vrata otpor potječe isključivo od trenja u šarki.
...
\begin{itemize}
    ...
    \item \texttt{add\_camera\_ros.py} dodaje kameru s izmjerenim unutarnjim parametrima i
          položajem te objavljivanje slike i stabla koordinatnih sustava.
\end{itemize}

Pojačanja pogona iz pretvorbe se ne zadržavaju, nego se postavljaju u konfiguraciji okruženja
(potpoglavlje \ref{sec:isaac}).
...
Programska podrška podijeljena je u pakete unutar radnog prostora ROS 2, navedene u tablici
\ref{tab:paketi}. Podjela slijedi funkcionalne cjeline rada: opis robota, percepcija, veza sa
simulatorom, izvođenje zadatka i pokretanje sustava.
...
Pristup temeljen na učenju koristi bitno jednostavniju arhitekturu. Tijekom učenja ROS 2 nije
