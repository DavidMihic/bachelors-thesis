...
Od dviju uobičajenih porodica oznaka odabran je AprilTag \cite{olson2011apriltag}, i to zbog
...
28 mm, pa je za njih odabrana familija s mrežom $4 \times 4$ umjesto $6 \times 6$: pri istoj
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lllll@{}}
        \toprule
        Oznaka     & Vrata    & Nosivi članak & Veličina & Familija \\
        \midrule
...
kamere. Kako jedan primjerak čvora obrađuje samo jednu familiju oznaka, pokreću se dva
...
neovisno o tome koliko je oznaka i kojih familija upotrijebljeno, pa se postupak detekcije može
...
udaljenost manju od otprilike 1,35 m, i to ne zbog razlučivosti nego zbog vidnog polja: bliže
...
\textbf{Točnost nije brojčano određena.} Rad modula provjeren je posredno, kroz uspješnost
hvata u cjelovitom zadatku, ali apsolutna pogreška procijenjene poze nije uspoređena sa
stvarnim položajem kvake u sceni. Takva bi usporedba razdvojila doprinos percepcije od
doprinosa upravljanja, što je pri ovakvom posrednom vrednovanju nemoguće.
TODO napravi mjerenje