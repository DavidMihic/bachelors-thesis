...
zadatka, nikada nije dio opažanja politike, nego se koristi isključivo u nagradi i pri prekidu epizode,
...
poprečnu i kutnu, pa politika sama koordinira ruku i platformu. Ukupna dimenzija akcijskog
prostora time iznosi petnaest.

Izlaz politike nije ni u jednoj dimenziji fizikalna veličina, nego bezdimenzijski broj koji se
množi pripadnim faktorom razmjera. Tablica \ref{tab:akcije} navodi te faktore i granice unutar
kojih rezultat završava, jer su oni nužni za ponovljivost postupka.

\begin{table}[H]
    \centering
    \caption{Sastav akcijskog prostora, faktori razmjera i granice}
    \label{tab:akcije}
    \begin{tabular}{@{}llll@{}}
        \toprule
        Komponenta                   & Dimenzija & Faktor razmjera \\
        \midrule
        Pomak reference, translacija & 3         & 0,015 m         \\
        Pomak reference, rotacija    & 3         & 0,1 rad         \\
        Krutost regulatora           & 6         & 300 N/m         \\
        Brzina platforme, uzdužna    & 1         & 0,1 m/s         \\
        Brzina platforme, poprečna   & 1         & 0,1 m/s         \\
        Brzina platforme, kutna      & 1         & 0,17 rad/s      \\
        \bottomrule
    \end{tabular}
\end{table}

Krutost je jedina veličina s tvrdom granicom. Donja granica sprječava da regulator posve popusti,
a gornja je odabrana tako da umnožak najveće krutosti i faktora razmjera pomaka iznosi 225 N,
dakle ispod praga od 280 N na kojem počinje kazna za prekomjernu silu. Politika time smije
odabrati i najveću krutost, a da je sama po sebi ne odvede u kaznu. Ostale su veličine
neograničene jer je akcija izlaz Gaussove razdiobe, pa je njihov doseg statistički, a ne propisan.

Izlaz politike tipično se kreće u rasponu od otprilike $\pm 3$, pa navedeni faktori daju pomak
reference reda nekoliko centimetara po koraku te brzinu platforme reda 0,3 m/s i 0,5 rad/s.
Prigušenje regulatora nije zasebna dimenzija akcije, nego se zadaje omjerom prigušenja jednakim
jedinici, dakle kritično prigušen odziv pri svakoj krutosti koju politika odabere.

Odabir faktora razmjera za krutost nije bio neutralan. Regulator akciju množi faktorom bez
pomaka, pa akcija jednaka nuli daje krutost nula, koja se potom ograničava na donju granicu.

Uz sam regulator djeluje i upravljanje u nul-prostoru, s krutošću 10 N/m i kritičnim
prigušenjem, koje redundantnu konfiguraciju ruke drži blizu nazivne. Bez njega lakat odluta u
singularitet ili zglobni limit iako vrh alata miruje na svojoj referenci.
...
Tablica \ref{tab:nagrada} navodi sve članove nagrade. Sve su težine određene empirijskim procesom
kalibracije tako da se provelo kraće treniranje politike (~300 iteracija) s grubo pretpostavljenom
težinom te se zatim težina skalirala linearno dok član nagrade ne iznosi između 3 i 10 \% udjela
člana napretka.
...
\begin{table}[H]
    ...
    \label{tab:nagrada}
    \begin{tabular}{@{}p{0.26\textwidth}r p{0.47\textwidth}@{}}
        \toprule
        Član                 & Težina              & Svrha                                                                         \\
        \midrule
        napredak             & $+10{,}0$           & glavni član, normiran na prag uspjeha                                         \\
        okomita sila         & $-0{,}02$           & kazni silu okomitu na stvarni smjer gibanja vrata                             \\
        zasićenje zglobova   & $-2{,}0$ / $-6{,}0$ & kazni rad blizu granice raspona zglobova ruke                                 \\
        singularitet         & $-20{,}0$           & kazni pad manipulabilnosti ispod praga                                        \\
        ubrzanje ruke        & $-5 \cdot 10^{-4}$  & kazni ubrzanje zglobova ruke                                                  \\
        trzaj ruke           & $-1 \cdot 10^{-7}$  & kazni trzaj, dakle drugu derivaciju brzine zglobova                           \\
        ...
        poravnanje platforme & $-0{,}1$ / $-6{,}0$ & kazni odstupanje platforme od okomice na ravninu vrata                        \\
        prodor u krilo       & $-20{,}0$           & kazni približavanje ruba platforme krilu ispod sigurnog razmaka               \\
        prodor u zid         & $-20{,}0$           & kazni približavanje ruba platforme zidu ili dovratniku ispod sigurnog razmaka \\
    ...
    \vspace{2mm}
    {\footnotesize Gdje su navedene dvije težine, prva vrijedi za klizna, a druga za zakretna
        vrata.}
\end{table}
...
\subsection{Nasumičnost pri početku epizode i kurikulum otpora}
\label{sec:nasumicnost}

Pri svakom početku epizode, kut prilaska platforme vratima nasumično se zakreće unutar $\pm$ 20\textdegree{}
oko nazivne vrijednosti. Otpor vrata bira se nasumično u rasponima navedenima u poglavlju
\ref{ch:sustav} (tablica \ref{tab:otpor-nasumicnost}).
...
vratima do pune vrijednosti iz tablice \ref{tab:otpor-nasumicnost}, nakon čega ostaje na punoj
...
PPO pripada obitelji postupaka s aktorom i kritikom, koji uče dvije odvojene neuronske mreže.
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}ll@{}}
        ...
        Koeficijent odsijecanja $\epsilon$                 & 0,2                                          \\
...
Slika \ref{fig:faze-rl} prikazuje karakteristične trenutke izvođenja naučene politike. Epizoda
počinje od stanja u kojem prihvatnica već drži kvaku, u skladu s opsegom iz potpoglavlja
\ref{sec:rl-opseg}, pa faze prilaska i hvata na slikama nema.

\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/rl_slike/rl_revolute_pocetak.png}
        \caption{zakretna: početak}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/rl_slike/rl_revolute_otvaranje.png}
        \caption{zakretna: otvaranje}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/rl_slike/rl_revolute_prolaz.png}
        \caption{zakretna: prolazak}
    \end{subfigure}

    \vspace{4pt}
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/rl_slike/rl_sliding_pocetak.png}
        \caption{klizna: početak}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/rl_slike/rl_sliding_otvaranje.png}
        \caption{klizna: otvaranje}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/rl_slike/rl_sliding_prolaz.png}
        \caption{klizna: prolazak}
    \end{subfigure}
    \caption{Faze izvođenja naučene politike na oba tipa vrata}
    \label{fig:faze-rl}
\end{figure}

Slika \ref{fig:trening-napredak} prikazuje tijek učenja dvjema veličinama. Gornji red je prosječni
otvor vrata, dobiven iz pripadnog člana nagrade dijeljenjem njegovom težinom i množenjem
referentnom vrijednošću. Riječ je o dvostrukom prosjeku, po vremenu unutar epizode i po svim
istovremenim okruženjima, pa je sustavno niži od otvora postignutog na kraju uspješne epizode:
epizoda počinje sa zatvorenim vratima, a u prosjek ulaze i okruženja u kojima otvaranje ne
uspije. Donji red prikazuje udio epizode tijekom kojeg su vrata iznad praga uspjeha, što izravnije
pokazuje koliko je politika naučila otvarati. Svijetla linija je vrijednost po iteraciji, a tamna
pomični prosjek.

Obje veličine konvergiraju, uz ustaljenu vrijednost u zadnjoj trećini učenja. Donja krivulja kreće
kasnije od gornje, jer politika najprije nauči vrata uopće pomaknuti, a tek potom otvoriti ih
dovoljno široko da prijeđe prag. Kod kliznih vrata ucrtana je i iteracija na kojoj završava
kurikulum otpora (potpoglavlje \ref{sec:nasumicnost}).

\begin{figure}[H]
    \centering
    \includegraphics{figures/trening_napredak.pdf}
    \caption{Tijek učenja: prosječni otvor vrata kroz epizodu, po iteraciji}
    \label{fig:trening-napredak}
\end{figure}

Obje politike konvergiraju, uz ustaljenu vrijednost u zadnjoj trećini učenja. Kod kliznih vrata
ucrtana je i iteracija na kojoj završava kurikulum otpora (potpoglavlje \ref{sec:nasumicnost}),
pa se vidi mijenja li se ponašanje kad politika prvi put vidi puni raspon otpora.

Slika \ref{fig:trening-prekidi} prikazuje kako se kroz učenje mijenjaju udjeli pojedinih razloga
prekida epizode.

\begin{figure}[H]
    \centering
    \includegraphics{figures/trening_prekidi.pdf}
    \caption{Udjeli razloga prekida epizode kroz iteracije učenja}
    \label{fig:trening-prekidi}
\end{figure}

Udio epizoda prekinutih istekom vremena raste kroz učenje, a udio onih prekinutih gubitkom hvata
i dodirom krila pada. Politika, dakle, ne uči samo otvarati vrata, nego prije svega prestaje
raditi ono zbog čega bi epizoda završila prerano.
...
prekida u nastavku tablice jesu udjeli epizoda i zbrajaju se na jedinicu.
