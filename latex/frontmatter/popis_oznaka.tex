...
\begin{longtable}{@{}p{0.18\textwidth}p{0.18\textwidth}p{0.56\textwidth}@{}}
    ...
    $\gamma$                           &                                  & Diskontni faktor (engl. \textit{discount factor})                                               \\
    $\lambda$                          &                                  & Faktor generalizirane procjene prednosti (engl. \textit{generalized advantage estimation, GAE}) \\
    $\epsilon$                         &                                  & Koeficijent odsijecanja (engl. \textit{clipping coefficient})                                   \\
